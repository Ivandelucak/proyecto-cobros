...
const navItems = [
  ...
  { href: "/productos", label: "Productos", adminOnly: true, group: "Gestion", icon: "box" },
  { href: "/categorias", label: "Categorias", adminOnly: true, group: "Gestion", icon: "tag" },
  { href: "/stock", label: "Stock", adminOnly: true, group: "Gestion", icon: "stock" },
  ...
  { href: "/reportes", label: "Reportes", adminOnly: true, group: "Control", icon: "chart" },
